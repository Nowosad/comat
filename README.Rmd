...
The goal of comat is to create cooccurrence matrices based using spatial data, including a weighted coocurrence matrix (wecoma).
...
The `get_wecoma` function can next be used to create a weighted cooccurrence matrix.
