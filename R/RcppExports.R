...
get_motifels <- function(input, directions, size, shift, what = "coma", fun = "mean", na_action = "replace") {
    .Call(`_comat_get_motifels`, input, directions, size, shift, what, fun, na_action)
}
