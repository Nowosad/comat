...
rcat = 1:3 # vector of categories assign to race  
...
rw = raster(nrows = 3, ncols = 3,
           xmn = 0, xmx = 3, ymn = 0, ymx = 3,
           crs = NA,
           vals = c(2, 2, 9, 6, 4, 9, 4, 8, 9))


clr = c("yellow", "darkgreen", "red") #colors for race categories
plot(r, col=clr)
plot(rw)
##########################
...
#Coocurence matrix dla przykładu 
[,1] [,2] [,3]
x1 12.0  5.0 13.5
x2  5.0 12.0 14.5
x3 13.5 14.5 49.0